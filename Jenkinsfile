pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://100.26.99.38:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/dineshkarthikalla8/Fullstack-Cicd-S-207-Practical-3.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://100.26.99.38:9090/springapp1"
            echo "✅ Frontend deployed: http://100.26.99.38:9090/frontapp1"
        }
        failure {
